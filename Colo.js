...
loader.load('./Models/colo.gltf' , (gltf) => {
  console.log(gltf);
  scene.add(gltf.scene);
  var TheSun = gltf.scene.getObjectByName("Sun");
  TheSun.intensity = 1;
...
document.getElementById('HideContent').addEventListener('click', function(){
  ...
  if(con.style.display === "none"){con.style.display = "flex"; console.log("changed to flex")}
